...
func (mq *MetadataQuery) QueryRecord() *RecordQuery {
...
func (mq *MetadataQuery) QueryMetadataFormat() *MetadataFormatQuery {
	query := (&MetadataFormatClient{config: mq.config}).Query()
	query.path = func(ctx context.Context) (fromU *sql.Selector, err error) {
		if err := mq.prepareQuery(ctx); err != nil {
			return nil, err
		}
...
func (mq *MetadataQuery) FirstID(ctx context.Context) (id int64, err error) {
	var ids []int64
...
func (mq *MetadataQuery) FirstIDX(ctx context.Context) int64 {
...
func (mq *MetadataQuery) OnlyID(ctx context.Context) (id int64, err error) {
	var ids []int64
...
func (mq *MetadataQuery) OnlyIDX(ctx context.Context) int64 {
...
func (mq *MetadataQuery) IDs(ctx context.Context) (ids []int64, err error) {
...
func (mq *MetadataQuery) IDsX(ctx context.Context) []int64 {
	ids, err := mq.IDs(ctx)
	if err != nil {
		panic(err)
	}
...
func (mq *MetadataQuery) Clone() *MetadataQuery {
	...
	return &MetadataQuery{
		...
		withMetadataFormat: mq.withMetadataFormat.Clone(),
...
func (mq *MetadataQuery) WithRecord(opts ...func(*RecordQuery)) *MetadataQuery {
	query := (&RecordClient{config: mq.config}).Query()
...
func (mq *MetadataQuery) WithMetadataFormat(opts ...func(*MetadataFormatQuery)) *MetadataQuery {
	query := (&MetadataFormatClient{config: mq.config}).Query()
	for _, opt := range opts {
		opt(query)
	}
	mq.withMetadataFormat = query
	return mq
}
...
//		GroupBy(metadata.FieldRecordID).
//		Aggregate(ent.Count()).
//		Scan(ctx, &v)
...
func (mq *MetadataQuery) sqlAll(ctx context.Context, hooks ...queryHook) ([]*Metadata, error) {
	...
	if query := mq.withRecord; query != nil {
		if err := mq.loadRecord(ctx, query, nodes, nil,
			func(n *Metadata, e *Record) { n.Edges.Record = e }); err != nil {
			return nil, err
		}
	}
	if query := mq.withMetadataFormat; query != nil {
		if err := mq.loadMetadataFormat(ctx, query, nodes, nil,
			func(n *Metadata, e *MetadataFormat) { n.Edges.MetadataFormat = e }); err != nil {
			return nil, err
		}
	}
	return nodes, nil
...
func (mq *MetadataQuery) loadRecord(ctx context.Context, query *RecordQuery, nodes []*Metadata, init func(*Metadata), assign func(*Metadata, *Record)) error {
	ids := make([]int64, 0, len(nodes))
	nodeids := make(map[int64][]*Metadata)
	for i := range nodes {
		fk := nodes[i].RecordID
...
func (mq *MetadataQuery) loadMetadataFormat(ctx context.Context, query *MetadataFormatQuery, nodes []*Metadata, init func(*Metadata), assign func(*Metadata, *MetadataFormat)) error {
	ids := make([]int64, 0, len(nodes))
	nodeids := make(map[int64][]*Metadata)
	for i := range nodes {
...
func (mq *MetadataQuery) querySpec() *sqlgraph.QuerySpec {
	_spec := sqlgraph.NewQuerySpec(metadata.Table, metadata.Columns, sqlgraph.NewFieldSpec(metadata.FieldID, field.TypeInt64))
	_spec.From = mq.sql
	...
	if fields := mq.ctx.Fields; len(fields) > 0 {
		...
		if mq.withRecord != nil {
			_spec.Node.AddColumnOnce(metadata.FieldRecordID)
		}
		if mq.withMetadataFormat != nil {
			_spec.Node.AddColumnOnce(metadata.FieldMetadataFormatID)
		}
	}
